  ...
  return (
    <SpotlightBorder className="w-full m-2 sm:m-0 sm:w-md h-[500px] p-4 flex flex-col text-sm justify-between items-center">
        <div className="flex flex-col gap-1 items-center">
            <div className="text-xl text-nowrap flex gap-2 font-semibold"> <TextScramble texts={['Welcome to']} letterSpeed={30} nextLetterSpeed={30}/> <span className="text-primary"><TextScramble texts={['Timeslot']} letterSpeed={30} nextLetterSpeed={30}/></span></div>
